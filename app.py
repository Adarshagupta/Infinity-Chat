...
def chatbot_script():
    try:
        ...
        with open('chatbot_script.js', 'r') as file:
            script = file.read()
        
        # Replace API_KEY placeholder with the actual API key
...
@app.route('/design1.css')
def design1():
    return send_file('design1.css', mimetype='text/css')

@app.route('/design2.css')
def design2():
    return send_file('design2.css', mimetype='text/css')
